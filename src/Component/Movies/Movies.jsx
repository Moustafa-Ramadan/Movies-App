...
export default function Movies() {
  ...
  return (
 <>
 {trendingMovies.length>0?<>{trendingMovies?<div className="row justify-content-center">  
...
</nav></>:<><div className="loadingScreein vh-100 d-flex justify-content-center align-items-center"><i className='fa-solid fa-spinner fa-spin fa-3x'></i></div></>}
