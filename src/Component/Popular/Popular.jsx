...
export default function Tv() {
  ...
  return (
 <>
 {PopularMovie.length>0?<>{PopularMovie?<div className="row justify-content-center">  
...
</>:<><div className="loadingScreein vh-100 d-flex justify-content-center align-items-center"><i className='fa-solid fa-spinner fa-spin fa-3x'></i></div></>}
